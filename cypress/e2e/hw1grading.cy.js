...
describe('Home Page Tests', () => {
    it('Check if questions are displayed in descending order of dates.', () => {
        const qTitles = ['cross platform mobile application development','iOS development concurrent modification exception','android studio save string shared preference, start activity and load the saved string', 'Programmatically navigate using React router'];
...
describe('New Question Form - Multiple questions', () => {
    it('Adds multiple questions one by one and displays them in All Questions', () => {
        ...
        const qTitles = ['Test Question 3', 'Test Question 2', 'Test Question 1','cross platform mobile application development','iOS development concurrent modification exception','android studio save string shared preference, start activity and load the saved string', 'Programmatically navigate using React router'];
        cy.get('.postTitle').each(($el, index, $list) => {
            cy.wrap($el).should('contain', qTitles[index]);
        });
...
describe('Active button verification test', () => {
    it('Adds a question, click active button, verifies the sequence', () => {
        ...
        const qTitles = ['Test Question A', 'android studio save string shared preference, start activity and load the saved string', 'Programmatically navigate using React router',  'cross platform mobile application development', 'iOS development concurrent modification exception']
        cy.get('.postTitle').each(($el, index, $list) => {
            cy.wrap($el).should('contain', qTitles[index]);
        })
    })
